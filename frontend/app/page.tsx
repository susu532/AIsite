      ...
      <main className="w-full max-w-3xl mx-auto flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col gap-8 w-full">
          ...
          <motion.form
            ...
            className="w-full bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg p-6 flex flex-col gap-4 border border-white/30 min-h-[60vh] justify-between"
            style={{ minWidth: '0', minHeight: '60vh', height: '100%' }}
          ...
          >
            ...
            <AnimatePresence>
              {generatedImage && (
                <motion.div
                  className="flex flex-col items-center justify-center mt-4 p-2 border rounded-xl bg-purple-50 text-purple-800 w-full"
                ...
                >
                  ...
                  <div className="w-full flex items-center justify-center">
                    <img
                      ...
                      alt="Générée par IA"
                      className="w-full object-contain border rounded-xl shadow-lg"
